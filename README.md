...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-activities-management-orchestrator-api/security/policy).
...
## Renaming from HMPPS Activities Management Orchestrator Api - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-activities-management-orchestrator-api=0
```
