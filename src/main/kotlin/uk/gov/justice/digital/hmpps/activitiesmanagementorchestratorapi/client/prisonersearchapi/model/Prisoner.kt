...
data class Prisoner(
  ...
  @get:JsonProperty("confirmedReleaseDate")
  val confirmedReleaseDate: java.time.LocalDate? = null,

  @Schema(example = "Mon May 01 01:00:00 BST 2023", description = "Actual Parole Date")
  @get:JsonProperty("actualParoleDate")
  val actualParoleDate: java.time.LocalDate? = null,

  @Schema(example = "Mon May 01 01:00:00 BST 2023", description = "Tariff Date")
  @get:JsonProperty("tariffDate")
  val tariffDate: java.time.LocalDate? = null,

  @Schema(example = "null", description = "")
  @get:JsonProperty("currentIncentive")
