...
data class EnrichedEventReviewDto(
  ...
  @Schema(description = "The prisoner related to this event",
    example = """{"bookingId":752833,"prisonerNumber":"G9372GQ","firstName":"JOE","lastName":"BLOGGS","cellLocation":"A-1-001"}""",
  )
  val prisoner: EnrichedEventReviewPrisonerDto? = null,
