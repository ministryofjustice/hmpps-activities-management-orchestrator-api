    ...
    runTest {
      whenever(
        eventReviewService.getEventsDataForReview(
          ...
          eq(true),
          eq(listOf("prison-offender-events.prisoner.released", "prison-offender-events.prisoner.remanded")),
          eq(2),
          eq(20),
          eq("descending"),
        ),
      ...
      webTestClient.get()
        .uri("/event-review/prison/MDI?date=2026-08-01&prisonerNumbers=A1234AA&prisonerNumbers=B2345BB&filterAcknowledged=true&filterEventTypes=prison-offender-events.prisoner.released&filterEventTypes=prison-offender-events.prisoner.remanded&page=2&size=20&sortDirection=descending")
        .exchange()
        .expectStatus().isOk
